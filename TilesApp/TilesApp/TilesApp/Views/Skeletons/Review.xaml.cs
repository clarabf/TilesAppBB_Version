    ...
    public partial class Review : BasePage
    {
        ...
        async void goToFamily(object sender, EventArgs args) {
            ...
            if (b.ClassId == "btParent")
            {
                ...
                await Navigation.PushModalAsync(new FamilyList(tempList, App.Inventory.FirstOrDefault(), ConfigFileName));
            }
            else if(b.ClassId == "btChildren")
            {
                await Navigation.PushModalAsync(new FamilyList(ChildrenDicts, App.Inventory.FirstOrDefault(), ConfigFileName));
            }
